...
const uint8_t LightToggleFrame::INIT[] = {0xAA, 0x23, 0xAC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x03, 0x41, 0x61,
...
bool PropertiesFrame::get_lights_enabled() const { return ((this->pbuf_[24] & 0x70) >> 4) != 7; }
